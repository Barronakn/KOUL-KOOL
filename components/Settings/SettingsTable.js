...
const initialOrders = [
  { id: '1', username: 'Company', category: "Resturant", adressCity: 'Adress', orderDate: '31 July 2024' },
  { id: '2', username: 'Company', category: "Resturant", adressCity: 'Adress', orderDate: '31 July 2024' },
  { id: '3', username: 'Company', category: "Resturant", adressCity: 'Adress', orderDate: '31 July 2024' },
];
        ...
        <Droppable droppableId="orders">
          {(provided) => (
            ...
            {...provided.dragHandleProps} ref={provided.innerRef}>
              <div  className="grid grid-cols-4 gap-2 p-3 text-sm font-medium text-gray-300">
                <div>Company</div>
                <div>Category</div>
                <div>Adress</div>
                ...
                <Draggable key={order.id} draggableId={order.id} index={index}>
                  {(provided) => (
                    <div
                      ...
                      className="grid grid-cols-4 gap-2 bg-white p-3 mb-2 rounded shadow"
                    >
